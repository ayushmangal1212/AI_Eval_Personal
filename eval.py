...
# DeepSeek / LLM configuration: allow overriding via environment variables.
# Default base URL points to the DeepSeek API host.
DEEPSEEK_BASE_URL = os.environ.get("DEEPSEEK_BASE_URL", "https://api.deepseek.com")
# Default model name for DeepSeek; can be overridden by setting DEEPSEEK_MODEL in env.
...
client = httpx.Client(verify=False)
# Primary LLM client using DeepSeek configuration
llm = ChatOpenAI(
